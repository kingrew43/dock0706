...
const UUID = process.env.UUID || '0ef24cc7-52b2-4270-97c3-cc1ce31205f4';
...
const ARGO_PORT = process.env.ARGO_PORT || 18000;           // Argo端口，使用固定隧道token需和cf后台设置的端口对应
const PORT = process.env.SERVER_PORT || process.env.PORT || 25000; // 节点订阅端口，若无法订阅请手动改为分配的端口
